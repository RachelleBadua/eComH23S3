...
<table>
	<tr><th><?= _('Date and Time') ?></th><th><?= _('Description') ?></th><th><?= _('actions') ?></th><th><?= _('actions') ?></th></tr>
<?php
...
foreach ($services as $service) { ?>
	<tr>
		...
		<td>
			<a href='/Service/delete/<?=$client->client_id?>'><?= _('delete') ?></a> | 
			<a href='/Service/edit/<?=$client->client_id?>'><?= _('edit') ?></a> |
		</td>
	</tr>
<?php
}
